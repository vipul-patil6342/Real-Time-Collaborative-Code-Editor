    ...
    return (
        <nav className="px-4 md:px-6 py-3 md:py-4 flex justify-between items-center backdrop-blur-sm border-b border-slate-700/50 sticky top-0 z-50">
            ...
            <div className="flex gap-2 md:gap-4 items-center">
                ...
                <button className="px-3 md:px-6 py-1.5 md:py-2 text-sm md:text-base bg-linear-to-r from-cyan-500 to-blue-500 rounded-md md:rounded-lg font-semibold text-white transition-all cursor-pointer whitespace-nowrap" onClick={() => navigate("/signup")}>
                    Get Started
                </button>
            </div>
        </nav>
